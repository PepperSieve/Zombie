...
impl FieldT {
    ...
    pub fn default_value(&self) -> FieldV {
        match self {
            Self::FCurve25519 => FieldV::FCurve25519(MyFr(Fr::zero())),
...
impl FieldV {
    ...
    pub fn recip_ref(&self) -> Self {
        match self {
            Self::FCurve25519(pf) => Self::FCurve25519(MyFr(pf.0.inverse().unwrap())),
        ...
        Integer: From<I>,
    {
        ...
        match ty {
            FieldT::FCurve25519 => {
                ...
                Self::FCurve25519(MyFr(Fr::from_bigint(i).unwrap()))
            }
    ...
    fn random(ty: FieldT, mut rng: impl rand::RngCore) -> Self {
        match ty {
            FieldT::FCurve25519 => Self::FCurve25519(MyFr(Standard.sample(&mut rng))),
...
impl Neg for FieldV {
    ...
    fn neg(self) -> Self {
        match self {
            Self::FCurve25519(pf) => Self::FCurve25519(MyFr(pf.0.neg())),
